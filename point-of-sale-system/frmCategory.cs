    ...
    public partial class frmCategory : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct = "select CategoryId from Category where CategoryId='" + txtID.Text + "'";
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("Category Item Already Exists", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtCategoryName.Text = "";
                    txtCategoryName.Focus();
                ...
                string cb = "insert into Category(CategoryId,CategoryName) VALUES ('" + txtID.Text + "','" + txtCategoryName.Text + "')";
